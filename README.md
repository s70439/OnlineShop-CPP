...
🎓 Learning Journey This project represents my first substantial C++ application developed during programming coursework. It showcases the transition from theoretical OOP concepts to practical implementation.
...
🔧 Technologies Language: C++ (C++11 standard)
...
📊 Future Enhancements File-based data persistence
...
👨‍💻 Author Dmitry Babak - Computer Science Student Specializing in Information Systems and Programming
